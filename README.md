...
| Retrofit                          | 2.2.0   | Type-safe HTTP client for Android and Java                                                | Apache 2.0                                                |
| Fetch                             | 1.1.5   | Fetch is a simple, powerful, customizable file download manager library for Android       | Apache 2.0                                                |
| Google Gson                       | 2.7.0   | Java library to serialize and deserialize Java objects to JSON                            | Apache 2.0                                                |
| Android Support and Play Services | 28.0.0  | Set of code libraries that provide backward compatible versions of Android framework APIs | Apache 2.0 GPL Creative Commons                           |
